...
--- requesting the first name, last name, and hire date for employees who were hired in 1986
 
SELECT first_name, last_name, hire_date
FROM employees
WHERE hire_date = TO_DATE('1986%', 'YYYY-MM-DD');

--- requesting each department manager's: department number, department name, the manager's employee number, last name, first name
 
...
---- requesting the department of each employee with their employee number, last name, first name, and department name
 
...
 
 
---- requesting the first name, last name, and sex for employees whose first name is "Hercules" and last names begin with "B."
 
SELECT first_name, last_name, sex
FROM employees
WHERE first_name = 'Hercules' AND last_name LIKE 'B%';

---- requesting the employees in the Sales department, including their employee number, last name, first name, and department name
 
 
...
----- requesting the employees in the Sales and Development departments, including their employee number, last name, first name, and department name
